...
# c flags
CFLAGS    = -Wall -Os  -DF_CPU=$(CLK) -mmcu=$(MCU) $(INCLUDE) -DDEVICE_ADDRESS=$(DEVICE_ADDR)
# any aditional flags for c++
CPPFLAGS =

# executables
AVRDUDE = avrdude -c $(PRG) -p $(MCU) -B $(PROG_SPEED)
OBJCOPY = avr-objcopy
OBJDUMP = avr-objdump
...
# read eeprom to mcu
eeprom_read:
	$(AVRDUDE) -U eeprom:r:$(EEPROM_IMG):r
